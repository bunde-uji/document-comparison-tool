...
// import InlineDiffViewer from '@/components'; // ← New import
...
export default function ComparePage() {
  ...
  const [viewMode, setViewMode] = useState<'words' | 'lines'>('words'); // ← New state
    ...
    <main className="min-h-screen bg-linear-to-br from-slate-50 to-slate-100">
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
            ...
            <div className="flex flex-wrap justify-between items-center gap-4 mb-6 bg-white p-4 rounded-lg shadow">
              <div className="flex gap-4 items-center flex-wrap">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    onClick={() => setViewMode(viewMode === 'words' ? 'lines' : 'words')}
                    className="px-3 py-1 bg-slate-100 text-slate-700 rounded 
                             hover:bg-slate-200 transition-colors text-sm font-medium"
                  >
                    {viewMode === 'words' ? '📝 Word-level' : '📄 Line-level'}
                  </button>
                </div>
        ...
        <footer className="mt-12 text-center text-slate-500 text-sm">
          <p>Built to help you understand track changes and minimize risk</p>
